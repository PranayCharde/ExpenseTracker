    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50/50 p-4 font-sans">
      <div className="max-w-md w-full animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 font-medium mt-2">Log in to manage your smart finances</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-100/50 border border-gray-100 overflow-hidden">
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div className="flex items-center justify-between text-[11px] font-bold uppercase tracking-wider text-gray-400">
              <label className="flex items-center gap-2 cursor-pointer hover:text-gray-900 transition-colors">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-200 text-brand-primary focus:ring-brand-primary" />
                Remember Me
              </label>
              <a href="#" className="text-brand-primary hover:text-blue-600 transition-colors">Forgot Password?</a>
            </div>
          ...
          <div className="bg-gray-50/50 p-6 text-center border-t border-gray-100">
            <p className="text-sm font-medium text-gray-500">
              ...
              <Link to="/signup" className="text-brand-primary font-bold hover:underline">Create Account</Link>
            </p>
          </div>
        </div>
      </div>
